export function RadixBackground() {
  return (
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="0.0833333" stopColor="hsl(272 51% 54% / 0.25)" />
            <stop offset="0.364583" stopColor="hsl(272 51% 50% / 0.15)" />
            <stop offset="0.658041" stopColor="hsl(var(--background))" />
            <stop offset="0.798521" stopColor="hsl(272 51% 58% / 0.08)" />
            <stop offset="0.942708" stopColor="hsl(var(--background))" />
          ...
          >
            <stop stopColor="hsl(var(--background))" />
            <stop offset="0.0833333" stopColor="hsl(280 50% 60% / 0.18)" />
            <stop offset="0.333803" stopColor="hsl(280 50% 65% / 0.12)" />
            <stop offset="0.658041" stopColor="hsl(var(--background))" />
            <stop offset="0.798521" stopColor="hsl(280 50% 55% / 0.08)" />
            <stop offset="0.942708" stopColor="hsl(var(--background))" />
            <stop offset="1" stopColor="hsl(var(--background))" />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop stopColor="hsl(var(--background))" />
            <stop offset="0.140625" stopColor="hsl(250 50% 60% / 0.2)" />
            <stop offset="0.333803" stopColor="hsl(250 50% 55% / 0.12)" />
            <stop offset="0.658041" stopColor="hsl(var(--background))" />
            <stop offset="0.798521" stopColor="hsl(250 50% 65% / 0.08)" />
            <stop offset="0.942708" stopColor="hsl(var(--background))" />
            <stop offset="1" stopColor="hsl(var(--background))" />
          </radialGradient>
          <radialGradient
          ...
          >
            <stop stopColor="hsl(var(--background))" />
            <stop offset="0.0833333" stopColor="hsl(270 55% 60% / 0.25)" />
            <stop offset="0.333803" stopColor="hsl(270 55% 65% / 0.15)" />
            <stop offset="0.658041" stopColor="hsl(var(--background))" />
            <stop offset="0.798521" stopColor="hsl(270 55% 55% / 0.08)" />
            <stop offset="0.942708" stopColor="hsl(var(--background))" />
            <stop offset="1" stopColor="hsl(var(--background))" />
          </radialGradient>
          <filter id="blur1">
