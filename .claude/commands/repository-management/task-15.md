# repository-management - Task 15

Execute task 15 for the repository-management specification.

## Task Description
创建响应式对话框组件

## Code Reuse
**Leverage existing code**: packages/web/src/components/ui/dialog.tsx 基础组件
...
## Usage
```
/Task:15-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建响应式对话框组件"

```
Use the @spec-task-executor agent to implement task 15: "创建响应式对话框组件" for the repository-management specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: 创建响应式对话框组件
- Leverage: packages/web/src/components/ui/dialog.tsx 基础组件
- Requirements: Requirement 6

## Instructions
- Implement ONLY task 15: "创建响应式对话框组件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 15 --mode complete
```
