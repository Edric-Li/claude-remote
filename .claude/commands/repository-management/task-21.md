# repository-management - Task 21

Execute task 21 for the repository-management specification.

## Task Description
实现缓存机制

## Code Reuse
**Leverage existing code**: 现有服务模式
...
## Usage
```
/Task:21-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现缓存机制"

```
Use the @spec-task-executor agent to implement task 21: "实现缓存机制" for the repository-management specification and include all the below context.
...
## Instructions
- Implement ONLY task 21: "实现缓存机制"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 21 --mode complete
```
