...
Execute task 14 for the repository-management specification.

## Task Description
创建改进的对话框样式文件

## Code Reuse
**Leverage existing code**: packages/web/src/components/ui/ 现有样式模式
...
## Usage
```
/Task:14-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建改进的对话框样式文件"

```
Use the @spec-task-executor agent to implement task 14: "创建改进的对话框样式文件" for the repository-management specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: 创建改进的对话框样式文件
- Leverage: packages/web/src/components/ui/ 现有样式模式
- Requirements: Requirement 6

## Instructions
- Implement ONLY task 14: "创建改进的对话框样式文件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 14 --mode complete
```
