# repository-management - Task 24

Execute task 24 for the repository-management specification.

## Task Description
性能监控和优化

## Code Reuse
**Leverage existing code**: 现有监控基础设施

## Requirements Reference
**Requirements**: Non-functional Performance Benchmarks

## Usage
```
/Task:24-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "性能监控和优化"

```
Use the @spec-task-executor agent to implement task 24: "性能监控和优化" for the repository-management specification and include all the below context.
...
## Instructions
- Implement ONLY task 24: "性能监控和优化"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 24 --mode complete
```
