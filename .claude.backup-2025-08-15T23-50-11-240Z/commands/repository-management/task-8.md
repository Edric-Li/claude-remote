# repository-management - Task 8

Execute task 8 for the repository-management specification.

## Task Description
添加智能默认分支选择

## Code Reuse
**Leverage existing code**: 任务 7 的分支解析结果
...
## Usage
```
/Task:8-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加智能默认分支选择"

```
Use the @spec-task-executor agent to implement task 8: "添加智能默认分支选择" for the repository-management specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: 添加智能默认分支选择
- Leverage: 任务 7 的分支解析结果
- Requirements: Requirement 4

## Instructions
- Implement ONLY task 8: "添加智能默认分支选择"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 8 --mode complete
```
