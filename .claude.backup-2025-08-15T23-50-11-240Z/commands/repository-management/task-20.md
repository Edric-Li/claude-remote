# repository-management - Task 20

Execute task 20 for the repository-management specification.

## Task Description
添加操作日志中间件

## Code Reuse
**Leverage existing code**: packages/server/src/modules/auth/ 现有中间件模式
...
## Usage
```
/Task:20-repository-management
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加操作日志中间件"

```
Use the @spec-task-executor agent to implement task 20: "添加操作日志中间件" for the repository-management specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: 添加操作日志中间件
- Leverage: packages/server/src/modules/auth/ 现有中间件模式
- Requirements: Non-functional Reliability

## Instructions
- Implement ONLY task 20: "添加操作日志中间件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks repository-management 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks repository-management 20 --mode complete
```
